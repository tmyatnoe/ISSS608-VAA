...
ggplot(sales_report, aes(x=Month, y=Sales)) + 
  ...
  geom_text(data = mins, aes(label = Sales), vjust = -1, size = rel(2.5)) +
  geom_text(data = maxs, aes(label = Sales), vjust = 2.5, size = rel(2.5)) +
  geom_text(data = ends, aes(label = Sales), hjust = 0, nudge_x = 0.5, size = rel(2.5)) +
  geom_text(data = ends, aes(label = Product), hjust = 0, nudge_x = 1.0, size = rel(2.5)) +
