...
[**ggstatsplot**](https://indrajeetpatil.github.io/ggstatsplot/) ![](image1.jpg){width="34" height="40"} is an extension of [**ggplot2**](https://ggplot2.tidyverse.org/) package for creating graphics with details from statistical tests included in the information-rich plots themselves.
...
### 10.5.1 Installing and loading the required libraries
