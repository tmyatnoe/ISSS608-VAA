...
Use **ggplot2** to chart transaction count by Planning Region and Property Type breakdown by quarter. Use ggplot2 extension called **patchwork** to combine separate ggplot2 graphs into a single figure. Use **ggtheme** to set Wall Street Journal theme.
...
2.  In terms of type of sale trend, 2024 Q1 Resale and Sub Sale are decreasing while only New sale showed an increasing trend.
:::

### 3.3 Data Visualization 3

In this visualization, let's take a look at price trend of the 2 proporty types with mostn umber of units sold, Apartments and Condominiums.
